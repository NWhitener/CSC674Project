...
def main():
    ...
    for run_index in range(1, 101):
        ...
        # Apply misdirection poisoning each iteration
        data = poison_utils.misdirection(data, number=200, complexity="minor")
        ...
        # Check rows that were tampered
        total_poison = (y == 1).sum()  # number of Tampered rows

        # For Isolation Forest, anomalies are labeled as -1
    ...
    df_all_runs.to_csv('misdirectionCancer.csv', index=False)
