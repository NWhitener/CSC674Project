...
def detect_poison(data): 
    '''
    Use the three outlier detection methods to determine if a data point is considered to be an anomlay across multiple methods
    If the majority agree that it is a anomly report it as being potentially poisoned
    '''
...
def main():
    ...
    print(data3['Poisoned'].value_counts())
